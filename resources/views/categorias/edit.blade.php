...
<div class="form-page">
    <div class="form-container">
        <div class="form-card">
            ...
            <!-- Form -->
            <form action="{{ route('categorias.update', $categoria) }}" method="POST" enctype="multipart/form-data" class="custom-form">
                @csrf
                @method('PUT')
                            ...
                            @if($categoria->imagen)
                                <div class="file-preview-item">
                                    ...
                                    <div class="file-preview-info">
                                        <span class="file-preview-name">Imagen actual</span>
                                        <span class="file-preview-size">Selecciona nueva imagen para reemplazar</span>
                                    </div>
                                    <img src="{{ asset('storage/'.$categoria->imagen) }}" alt="{{ $categoria->nombre }}" class="image-preview-small">
                                </div>
                            @endif
                        </div>
                    </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Si ya hay una imagen existente, mostrar el área de preview
        @if($categoria->imagen)
