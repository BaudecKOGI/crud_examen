...
<div class="form-page">
    <div class="form-container-wide">
        <div class="form-card-wide">
            ...
            <!-- Form -->
            <form action="{{ route('productos.update', $producto) }}" method="POST" enctype="multipart/form-data" class="custom-form-grid">
                @csrf
                @method('PUT')
                ...
                <div class="form-right">
                    <div class="image-upload-section">
                        ...
                        <div class="upload-area" id="uploadArea">
                            ...
                            @if($producto->imagen)
                                ...
                                <div class="preview-container" id="previewContainer">
                                    <img id="imagePreview" src="{{ asset('storage/'.$producto->imagen) }}" alt="Preview">
                        ...
                        <p class="image-hint">Deja vacío si no deseas cambiar la imagen</p>
                    </div>

                    <div class="info-card-edit">
                        <div class="info-icon-edit">📝</div>
                        ...
                        <div class="info-detail">
                            ...
                            <span class="info-value">{{ $producto->created_at->format('d/m/Y') }}</span>
                        </div>
                        <div class="info-detail">
                            <span class="info-label">Última actualización:</span>
                            <span class="info-value">{{ $producto->updated_at->format('d/m/Y') }}</span>
                        </div>
                    </div>
                </div>
